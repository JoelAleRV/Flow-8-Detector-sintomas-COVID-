/*
 ...
 Por: Joel Vargas
 Fecha: 30 de agosto del 20222

 Este programa realizara la lectura del 
...
//Datos de WiFi
const char* ssid = "Totalplay-C59A";  // Aquí debes poner el nombre de tu red
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    String json = "{\"id\":\"Joe\",\"temp\":"+String(random(18, 23))+",\"hum\":"+String(random (38,52))+"}";
